...
#when bot is ready, it will send this msg
@bot.event
async def on_ready():
    print(f'Bot is ready. Logged in as {bot.user}')

#!start -> used to check bot is active
...
#!info -> to see what the bot can do
...
#!new_project -> making a new project
...
async def new_project(ctx):
    ...
    #check the message, and then ask for link
...
#!projects -> checking pre existing projects
...
async def get_projects(ctx):
    ...
    if projects:
        ...
        #if message sent does not match project, send this message
        await ctx.send('Kamu belum memiliki proyek!\nKamu dapat menambahkannya menggunakan perintah !new_project')

#!skills -> connecting a skill to the pre existing project
...
async def skills(ctx):
    ...
    if projects:
        ...
        if skill.content not in skills:
            #if message sent does not match skill, send this message
...
#!delete -> delete a pre existing project
...
#!update_projects -> update a pre existing project
...
async def update_projects(ctx):
    ...
    if projects:
        ...
        #if attribute sent does not match project, send this message
